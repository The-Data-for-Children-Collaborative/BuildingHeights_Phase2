...
class PP(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv1 = nn.Conv2d(in_channels, 128, kernel_size=3, padding=1, stride=1, bias=True, padding_mode='zeros')
        self.conv2 = nn.Conv2d(128, out_channels, kernel_size=3, padding=1, stride=1, bias=True, padding_mode='zeros')

    def forward(self, x):

        xprime = self.conv1(x)
        xprimeprime = self.conv2(xprime)
        return xprimeprime
